...
namespace qlsv.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        {
            var qlsvContext = _context.SinhVien.Include(s => s.Lop);
        ...
        {
            ViewData["MaLop"] = new SelectList(_context.Set<Lop>(), "MaLop", "TenLop");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("MaSinhVien,TenSinhVien,NgaySinh,GioiTinh,MaLop")] SinhVien sinhVien)
        {
            ...
            ViewData["MaLop"] = new SelectList(_context.Set<Lop>(), "MaLop", "TenLop", sinhVien.MaLop);
            return View(sinhVien);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'qlsvContext.SinhVien'  is null.");
            }
            var sinhVien = await _context.SinhVien.FindAsync(id);
            if (sinhVien != null)
            {
